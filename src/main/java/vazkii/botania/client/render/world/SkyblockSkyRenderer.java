...
public class SkyblockSkyRenderer {
    ...
    private static final Identifier textureSkybox = new Identifier("gogskybox", "skybox.png");
    private static final Identifier textureRainbow = new Identifier("gogskybox", "rainbow.png");
    private static final Identifier[] planetTextures = new Identifier[] {
        new Identifier("gogskybox", "planet0.png"),
        new Identifier("gogskybox", "planet1.png"),
        new Identifier("gogskybox", "planet2.png"),
        new Identifier("gogskybox", "planet3.png"),
        new Identifier("gogskybox", "planet4.png"),
        new Identifier("gogskybox", "planet5.png")
    };
    ...
    public static void renderExtra(MatrixStack ms, ClientWorld world, float partialTicks, float insideVoid) {
        ...
        for (int p = 0; p < 3; p++) {
            float baseAngle = rotSpeed * rotSpeedMod * (GoGSkybox.ticks + GoGSkybox.partial);
            ms.multiply(Vector3f.POSITIVE_Y.getDegreesQuaternion((GoGSkybox.ticks + GoGSkybox.partial) * 0.25F * rotSpeed * rotSpeedMod));
    ...
    public static void renderStars(VertexFormat format, VertexBuffer starVBO, MatrixStack ms, float partialTicks) {
        ...
        float t = (GoGSkybox.ticks + partialTicks + 2000) * 0.005F;
        ms.push();
